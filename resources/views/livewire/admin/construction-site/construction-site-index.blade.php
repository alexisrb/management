<div class="pt-4">
    <div class="card">
        ...
        <h5 class="text-center my-2">Todos los Escenario de Obra</h5>
        </div>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-7">
                    <div class="input-group my-2">
                        ...
                        <input wire:model="search" class="form-control" placeholder="Ingrese el nombre de la obra">
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                    <a type="button" class="btn btn-success" href="{{ route('admin.construction-site.create', $user) }}">Agregar</a>
                </div>
            </div>
        </div>
    </div>
