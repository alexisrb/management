<div class="pt-4">
    <div class="card">
        ...
        <h5 class="text-center my-2">Todas las Licitaciones</h5>
        </div>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-7">
                    <div class="input-group my-2">
                        ...
                        <input wire:model="search" class="form-control" placeholder="Ingrese el nombre de la licitación">
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                    <a type="button" class="btn btn-success" href="{{ route('admin.licitaciones.create', $user) }}">Crear</a>
                </div>
            </div>
        </div>
