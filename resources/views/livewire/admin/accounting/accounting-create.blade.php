                ...
                <div class="row rounded border mb-4">
                    ...
                    <div class="col m-2">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <label class="col-form-label">
                                    {{ __('Fecha Inicial del periodo') }}
                                </label>
                                <input type="date" id="fecha_de_periodo" class="form-control" wire:model="fecha_de_periodo" placeholder="Ingrese la fecha">
                                @error('fecha_de_periodo') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-12">
                                <label class="col-form-label">
                                    {{ __('Fecha Final del periodo') }}
                                </label>
                                <input type="date" id="fecha_de_periodo" class="form-control" wire:model="fecha_de_periodo" placeholder="Ingrese la fecha">
                                @error('fecha_de_periodo') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            ...
                            <div class="form-group col-12">
                                <label class="col-form-label">
                                    {{ __('Afectacion Presupuestal') }}
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" id="presupuestal" class="form-control" wire:model="presupuestal" placeholder="Ingrese el nombre">
                                @error('presupuestal') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            {{--<div class="form-group col-12">
                                <label class="col-form-label">
                                    {{ __('Whatsapp') }}
