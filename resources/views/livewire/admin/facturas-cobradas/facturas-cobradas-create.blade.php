                ...
                <div class="row rounded border mb-4">
                    ...
                    <div class="col m-2">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <label class="col-form-label">
                                    {{ __('Nombre de la Factura') }}
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" id="num_factura" class="form-control" wire:model="num_factura" placeholder="Ingrese el nombre de la factura">
                                @error('num_factura') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label class="col-form-label">
                                    {{ __('Numero de la Factura') }}
                                    <span class="text-danger">*</span>
                                </label>
                                <input type="text" id="número_de_factura" class="form-control" wire:model="número_de_factura" placeholder="Ingrese su numero de factura">
                                @error('número_de_factura') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-12">
                                <label class="col-form-label">
                                    {{ __('Domicilio') }}
                    ...
                    <div class="col m-2">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-sm-6 col-md-4 col-xl-4">
                                ...
                                <input type="file" class="form-control-file" id="documento_de_factura_dos" wire:model.defer="documento_de_factura_dos">
                                @error('documento_de_factura_dos') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-12 col-sm-6 col-md-4 col-xl-4">
                                <label class="col-form-label">
                                    {{ __('Factura 3') }}
                                ...
                                <input type="file" class="form-control-file" id="documento_de_factura_tres" wire:model.defer="documento_de_factura_tres">
                                @error('documento_de_factura_tres') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-12 col-sm-6 col-md-4 col-xl-4">
                                <label class="col-form-label">
                                    {{ __('Factura 4') }}
                                ...
                                <input type="file" class="form-control-file" id="documento_de_factura_cuatro" wire:model.defer="documento_de_factura_cuatro">
                                @error('documento_de_factura_cuatro') <span class="text-danger error">{{ $message }}</span>@enderror
                            </div>
                        </div>
                    </div>
                </div>
