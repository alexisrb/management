<div class="pt-4">
    <div class="card">
        ...
        <h5 class="text-center my-2">Todos los Avances de obras</h5>
        </div>
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-7">
                    <div class="input-group my-2">
                        ...
                        <input wire:model="search" class="form-control" placeholder="Ingrese el nombre del avance">
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                    <a type="button" class="btn btn-success" href="{{ route('admin.advances.create', $user) }}">Agregar</a>
                </div>
            </div>
        </div>
    </div>
