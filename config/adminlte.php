...
return [
    ...
    */
    ...
    'menu' => [
        // Navbar items:
        //['header' => 'Sistema GECO'],
        ['header' => 'Gestion y Cobranza Grupo Makro'],
        ['header' => ''],
        [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'route'  => 'admin.work-program.index',
                    'icon' => 'fa fa-book',
                ],
                [
                    'text' => 'Programa de Érogaciones',
                    'route'  => 'admin.disbursements.index',
                    'icon' => 'fa fa-book',
                ],
                [
                    'text' => 'Escenario de Obra',
                    'route'  => 'admin.construction-site.index',
                    'icon' => 'fa fa-book'
                ],
            ],
        ],
        [
            'text'    => 'Gerencia de Obra',
            'icon' => 'fa fa-microchip',
            'submenu' => [
                [
                    'text' => 'Avances Físicos',
                    'route'  => 'admin.advances.index',
                    'icon' => 'fas fa-solid fa-money-bill',
                ],
                
                [
                    'text' => 'Carga de Estimación',
