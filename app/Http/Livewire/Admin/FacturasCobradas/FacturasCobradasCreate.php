...
class FacturasCobradasCreate extends Component
{
    use WithFileUploads;
    ...
    public function save(){
        ...
        return redirect(route('admin.facturas-cobradas.index'));
    ...
    {
        return view('livewire.admin.facturas-cobradas.facturas-cobradas-create');
    }
